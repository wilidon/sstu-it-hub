...
@Service
public class EventAvatarLoader extends FileLoader {


    public EventAvatarLoader(final @Value("${s3.uploadEndpoint}") String uploadEndpoint,
    ...
    public String load(MultipartFile file) throws IOException {
        ...
        String filename = "events/" + UUID.randomUUID() + fileExtension;
