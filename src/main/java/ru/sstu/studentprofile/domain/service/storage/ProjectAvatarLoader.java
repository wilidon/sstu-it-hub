...
@Service
public class ProjectAvatarLoader extends FileLoader{
    public ProjectAvatarLoader(final @Value("${s3.uploadEndpoint}") String uploadEndpoint,
    ...
    public String load(MultipartFile file) throws IOException {
        ...
        String filename = "projects/" + UUID.randomUUID() + fileExtension;
